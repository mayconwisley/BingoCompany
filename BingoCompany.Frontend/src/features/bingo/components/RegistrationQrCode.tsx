...
export function RegistrationQrCode({ registrationPath }: Props)
{
    ...
    return imageUrl ? <figure className="registration-qr"><img src={imageUrl} alt="QR Code para inscrição no bingo" /><figcaption>Aponte a câmera para se inscrever e gerar sua cartela.</figcaption></figure> : null;
}
