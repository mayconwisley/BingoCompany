...
const PrintedWinnerValidationPage = lazy(() =>
	import("../pages/printed-winner-validation/PrintedWinnerValidationPage").then(({ PrintedWinnerValidationPage: page }) => ({
		default: page
	}))
);
	...
	return (
		<Suspense fallback={<RouteLoadingState />}>
			<Routes>
				...
				/>
				<Route
					path="/operacao/:eventId/:roundId/conferir-cartelas"
					element={
						<ProtectedRoute>
							<PrintedWinnerValidationPage />
						</ProtectedRoute>
					}
				/>
