		...
		try {
			...
			setSuccess(
				result.tieBreakerRequired
					? `${result.participantName} entrou no empate.`
					: `${result.participantName} foi confirmado(a) como candidato(a).`
			);
				...
				<header className="pagehead">
					<div>
						...
						<p className="subtitle">
							Leia o QR Code da cartela apresentada. O sistema confere a regra usando somente as pedras já sorteadas.
						</p>
					</div>
				</header>
