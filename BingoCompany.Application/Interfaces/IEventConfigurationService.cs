...
public interface IEventConfigurationService
{
	...
	Task<bool> OpenCardPurchase(Guid eventId, int quantity, int perParticipantLimit, DateTimeOffset? closesAt, int lowStockThreshold, CancellationToken cancellationToken);
}
